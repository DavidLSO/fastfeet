...
export function* getDeliveries() {
  try {
    ...
    Alert.alert(
      'Falha na requisição!',
      'Falha ao tentar recuperar as encomendas!',
    );
  }
}
...
export function* createDeliveries({payload}) {
  try {
    ...
    Alert.alert('Falha na requisição!', 'Falha ao tentar criar encomenda !');
  }
}
...
export function* updateDeliveries({payload}) {
  try {
    ...
    Alert.alert('Falha na requisição!', 'Erro ao atualizar uma encomenda !');
  }
}
...
export function* deleteDeliveries({payload}) {
  try {
    ...
    Alert.alert('Falha na requisição!', 'Falha ao deletar a encomenda !');
  }
}
